...
import MassAssistantCallHistory, { dummyCallHistoryData } from "@/components/Features/call-history/mass-assistant-call-history";

const MassAssistantCallHistoryPage = () => {
  const { id } = useParams();
  ...
  return (
    <div className="flex flex-col h-screen gap-5">
      ...
      <div className="flex flex-col gap-y-6 h-full bg-white border py-6 rounded-lg px-4 sm:px-9">
        ...
        <MassAssistantCallHistory data={dummyCallHistoryData} />
      </div>
    </div>
  );
};

export default MassAssistantCallHistoryPage;
