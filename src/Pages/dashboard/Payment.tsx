...
const Payment = ({onEditBot, onDuplicateBot}:BotsContentProps) => {
    const [transactionData, setTransactionData] = useState<Transaction[]>(transactionsData)
    const [activeMenu, setActiveMenu] = useState<string>(tabMenu[0])
    const [selectedTransaction, setSelectedTransaction] = useState<string[]>([])
  // const [currentPage, setCurrentPage] = useState(1)
    const [deleteModalOpen, setDeleteModalOpen] = useState(false)
    const [botToDelete, setBotToDelete] = useState<Transaction | null>(null)
  ...
  return (
    <div className='py-5 px-5 md:px-7 lg:px-[50px] bg-secondary flex flex-col gap-y-5 w-full'>
        ...
        <main className='flex flex-col gap-y-6'>
            ...
            {activeMenu === tabMenu[0] && <section className='py-6 px-3 md:px-9 bg-background rounded-lg flex flex-col gap-y-5'>
                {/* Search and Filters */}
                ...
                {/* <Card> */}
                    ...
                    <TableBody>
                        ...
                        <TableRow key={transaction.id}>
                            ...
                            <Badge
                                variant={transaction.subscriptionType === "Bot created" ? "default" : "secondary"}
                                className={
