...
const steps = [
  {
    ...
    title: "Understanding",
    description:
      "Kool AI understands what your customers want and gives clear answers that make sense.",
  },
  {
    icon: users,
    title: "Presence",
    description:
      "Connect with customers on Instagram, WhatsApp, email, and your website—wherever they are.",
  },
  {
    icon: chat,
    title: "Automate",
    description:
      "It follows up with customers, sends quotes, and reminds them so you don't have to do anything.",
  },
  {
    icon: database,
    title: "Analyze",
    description:
      "Kool AI monitors what works, what doesn't, and pinpoint areas to focus your efforts for better results.",
  },
];
...
export function EnhancedHowItWorksSection() {
  ...
  return (
    <section
      id="how-it-works"
      className="py-16 lg:py-14 bg-white overflow-hidden"
    >
      <div className="max-w-screen-2xl mx-auto px-4 md:px-12 lg:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-x-32 items-center">
          ...
          >
            ...
            <div className="relative z-[2]">
              <img
                ...
                className="w-full lg:-mb-[180px] md:mt-14 h-auto max-w-xl ld:max-w-lg lg:mx-auto"
              />
            </div>
          ...
          {/* Right Side - Content */}
          <div
            className={`transition-all flex items-end h-full duration-1000 delay-300 ${
              isVisible
                ? "opacity-100 translate-x-0"
                : "opacity-0 translate-x-10"
            }`}
