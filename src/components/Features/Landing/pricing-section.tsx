...
export function PricingSection() {
  ...
  return (
    <section id="pricing" className="py-4 sm:py-12 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Choose your plan</h2>
          <p className="text-lg text-gray-600 mb-8">Flexible Plans for Every Business</p>
          ...
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              <div className="mb-8">
                ...
                <p className={`text-sm ${plan.popular ? "text-blue-100" : "text-gray-600"} mb-6`}>{plan.description}</p>
