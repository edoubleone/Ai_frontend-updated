                ...
                <section className="flex flex-col gap-y-6">
                    {howItWorksList.map((listItem, index) => (
                        <div key={index} className="flex gap-x-8 md:gap-x-16">
                            <div className="flex flex-col items-center gap-y-2 text-blue-600"><p className="font-bold text-2xl md:text-3xl">0{index+1}</p><div className="w-[2px] h-full bg-blue-600" /></div>
