...
function Widget() {
  const { values, setFieldValue } = useFormikContext<WidgetFormValues>();

  const settings = values.widgetSettings || {
    business_id: "",
  ...
  const handleToggle = (
    ...
    setFieldValue(
      `widgetSettings.${section}.enabled`,
  ...
  const handleInputChange = (
    ...
    setFieldValue(`widgetSettings.${field}`, value);
  };
