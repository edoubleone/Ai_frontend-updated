      ...
      <div className="flex flex-col gap-y-6 mt-6">
        <div>
          ...
          <p className="text-base text-[#737373]">
            Set up the integration to send and receive messages via Facebook
            Messenger. Specify the access parameters provided by your Facebook
            Messenger API provider.
          </p>
        </div>
        ...
        <Alert className="bg-[#EEEEFD] space-x-5">
          ...
          <AlertDescription className="text-[#454545] text-base">
            ...
            <ul className="list-disc">
              ...
              access to invite you as an administrator with full permissions so
              you can create WhatsApp Business Accounts (WABA).
              <li>
              ...
              <li>
                ...
                Business Portfolio (usually handled by the marketing
                department).
              </li>
              <li>
                If a Meta Business Portfolio already exists, ask a user with
