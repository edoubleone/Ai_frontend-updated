  ...
  return (
    <DialogContent>
      <div className="flex flex-col gap-y-6 mt-6">
        <div>
          <h1 className="text-dark font-bold text-lg">WhatsApp setup</h1>
          <p className="text-base text-[#737373]">
            Set up the integration to send and receive messages via WhatsApp.
            Specify the access parameters provided by your WhatsApp API
            provider.
          </p>
        </div>
