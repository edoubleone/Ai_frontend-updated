  ...
  return (
    <DialogContent>
      <div className="flex flex-col gap-y-6 mt-6">
        <div>
          <h1 className="text-dark font-bold text-lg">Slack setup</h1>
          <p className="text-base text-[#737373]">
            Set up the integration to send and receive messages via Slack.
            Specify the access parameters provided by your Slack API provider.
          </p>
        </div>
        ...
        <Alert className="bg-[#EEEEFD] space-x-5">
          ...
          <AlertDescription className="text-[#454545] text-base">
            ...
            <ul className="list-disc">
              ...
              <li>
                f a Meta Business Portfolio already exists, ask a user with
        ...
        <DialogFooter>
          <Button wrapperclass="!max-w-[180px]">Continue with Slack</Button>
        </DialogFooter>
      </div>
    </DialogContent>
  );
