  ...
  return (
    <DialogContent>
      <div className="flex flex-col gap-y-6 mt-6">
        <div>
          <h1 className="text-dark font-bold text-lg">Instagram setup</h1>
          <p className="text-base text-[#737373]">
            Set up the integration to send and receive messages via Instagram.
            Specify the access parameters provided by your Instagram API
            provider.
          </p>
        </div>
        ...
        <DialogFooter>
          <Button wrapperclass="!max-w-[180px]">Continue with Instagram</Button>
        </DialogFooter>
      </div>
    </DialogContent>
  );
