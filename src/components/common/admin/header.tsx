...
import { ChevronDown, CircleUser, MenuIcon } from "lucide-react";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
  ...
  return (
    <header className="flex sticky top-0 z-40 w-full items-center justify-between px-4 sm:px-8 lg:px-12 py-3.5 bg-white border-b-[1.13px] border-[#E7E7E7]">
      <div className="flex items-center gap-x-3">
        ...
        <p className="text-dark text-2xl font-semibold">Super Admin</p>
      </div>
      ...
      <div className="flex items-center gap-2.5">
        <IconButton
          ...
          size={"icon"}
        >
          <img src="/icon/notification.svg" alt="notifications icon" />
        </IconButton>
